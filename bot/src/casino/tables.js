 ...
 *
 * 칩이 영구 저장이 되면서 생긴 규칙 하나: **한 계정은 한 번에 한 판에만 앉는다.**
 *
 * 증감을 보내는 방식이라 산수 자체는 순서가 섞여도 맞다. 문제는 **같은 칩을 두 곳에서
 ...
 * 올려 준다 — 매일 공짜 칩이 풀에 들어간다.
 *
 * 나중에 `/아이템 양도` 도 이걸 쓴다. 판이 도는 동안 칩은 인메모리 장부에만 있고 서버는

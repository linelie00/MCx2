...
console.log('\n모양');
eq('248종 — 시트 95 + 요리 재료 42+22 + 독 8 + 괴식 10 + 낚시 24+24 + 미끼 2 + 농장 작물 17 + 개간 1 + 거름 2 + 귀마개 1', SHEET.length, 248);
...
eq('재료 백일흔넷 — 장보기 둘째 배치로 스물둘, 농장 작물로 열일곱이 늘었다', FOOD.length, 174);
...
eq('없는 키를 주면 목록으로', read(await show('없는키')).fields[0], '종류=**254**');
...
eq('재료 탭', [c.fields[0], c.fields[1]], ['종류=**180**', '쪽=1 / 9']);

 ...
 * /api/auth/me 로 확인한다. 봇을 띄우지 않고도 값만 빠르게 검증할 수 있다.
 *
...
console.log();
if (allOk) {
  console.log('두 키 모두 정상입니다. 봇에서 쓰기 명령을 쓸 수 있습니다.');
} else {
  console.log('Railway 의 server 서비스 > Variables 에서 OWNER_*_KEY 값을 확인해 복사해 주세요.');

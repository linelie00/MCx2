...
const SYSTEM = {
  cook: [
    ...
    '묘사하고, 대성공이면 기막힌 결과를 묘사한다. 점수(fit·craft·harmony)는 주사위와 따로,',
...
const COMMON = [
  ...
  '- **길이가 아니라 핵심 공정을 짚었는지 본다.** 한두 줄이라도 필요한 공정(손질·익힘·간·',
  '  가공)을 짚었으면 충분히 줄 수 있다. 길게 늘어놓아도 핵심이 빠졌거나 꾸밈말뿐이면 낮게.',
  '  핵심 없이 "굽는다"·"만든다" 뿐이면 조리·과정 점수를 절반 아래로.',

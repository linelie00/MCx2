...
export const ITEMS = [
  ...
  { key: 'strawberry',      name: '딸기',                    kind: '재료', cat: 'veg',   price:    5, sell: true,  heal:   6,  shop: true, desc: '씨가 겉에 있다. 과일 중에 드문 일이다.' },
  { key: 'peach',           name: '복숭아',                  kind: '재료', cat: 'veg',   price:    6, sell: true,  heal:   7,  shop: true, desc: '껍질에 솜털이 있다. 만지면 간지럽다.' },
  { key: 'watermelon',      name: '수박',                    kind: '재료', cat: 'veg',   price:   12, sell: true,  heal:  10,  shop: true,  loot: false, desc: '들고 다니기엔 너무 크다. 그래도 여름엔 다들 들고 다닌다.' },

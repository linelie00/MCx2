...
const compostable = (items, crops) => (crops ?? [])
...
async function openCompost(interaction, { owner = interaction.user.id, crop = null, note } = {}) {
...
async function compostButton(interaction, act, [arg, owner]) {
  if (interaction.user.id !== owner) {

...
export const TITLES = [
  ...
  { key: 'stoneBreaker', name: '값진 노동', tier: 1, cond: '돌·바위 50개 치우기', group: '농장', desc: '밭은 돌을 치운 만큼 넓어진다.', when: (s) => n(s, 'farmClear') >= 50 },
  ...
  { key: 'goldenHand', name: '농사의 달인', tier: 2, cond: '★★★ 작물 5종 거두기', group: '농장', desc: '심기만 하면 윤이 난다.', when: (s) => n(s, 'farmStar3Kinds') >= 5 },
  { key: 'giantGrower', name: '요정 대모', tier: 3, cond: '대왕 작물 1번', group: '농장', desc: '아홉 칸이 하나로 합쳐졌다. 수레가 부서졌다.', when: (s) => n(s, 'farmGiant') >= 1 },
